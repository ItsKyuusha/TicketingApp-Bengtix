    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 w-64 is-drawer-close:w-14 is-drawer-open:w-80">
        ...
        <ul class="menu w-full grow gap-1">
            ...
            <li class="{{ request()->routeIs('admin.payment-types.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('admin.payment-types.index') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Kategori">
                    <!-- icon Tipe Tiket -->
            ...
            <li class="{{ request()->routeIs('admin.lokasi.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('admin.lokasi.index') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Kategori">
                    <!-- icon Lokasi -->
